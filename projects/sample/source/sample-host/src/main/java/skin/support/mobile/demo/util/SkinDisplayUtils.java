...
//    private static int[] sLandscapeRealSizeCache = null;
    ...
    public static int getScreenHeight(Context context) {
        ...
        if(SkinDeviceUtils.isXiaomi() && xiaomiNavigationGestureEnabled(context)){
...
//        }
    ...
    public static int getUsefulScreenWidth(Activity activity) {
        return getUsefulScreenWidth(activity, SkinNotchUtils.hasNotch(activity));
    }

    public static int getUsefulScreenWidth(View view) {
        return getUsefulScreenWidth(view.getContext(), SkinNotchUtils.hasNotch(view));
    }
    ...
    public static int getUsefulScreenWidth(Context context, boolean hasNotch) {
        ...
        if (isLandscape) {
            ...
            if (SkinDeviceUtils.isHuawei() && !SkinDisplayUtils.huaweiIsNotchSetToShowInSetting(context)) {
                result -= SkinNotchUtils.getNotchSizeInHuawei(context)[1];
            }
    ...
    public static int getUsefulScreenHeight(Activity activity) {
        return getUsefulScreenHeight(activity, SkinNotchUtils.hasNotch(activity));
    }

    public static int getUsefulScreenHeight(View view) {
        return getUsefulScreenHeight(view.getContext(), SkinNotchUtils.hasNotch(view));
    }
